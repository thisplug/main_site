// Ported from React Bits — https://reactbits.dev/backgrounds/color-bends
...
export function ColorBends({
  ...
  useEffect(() => {
    ...
    const colorUniforms = material.uniforms.uColors.value as THREE.Vector3[]
    for (let i = 0; i < MAX_COLORS; i++) {
      const vec = colorUniforms[i]
